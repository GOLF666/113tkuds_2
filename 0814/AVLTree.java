public class AVLTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("插入節點：10, 5, 15, 3, 8");
        tree.insert(10);
        tree.insert(5);
        tree.insert(15);
        tree.insert(3);
        ...
        System.out.println("列印樹：");
        tree.printTree();

        System.out.println("搜尋 8: " + tree.search(8));
        System.out.println("搜尋 20: " + tree.search(20));

        System.out.println("刪除節點 5");
        tree.delete(5);

        System.out.println("刪除後列印：");
        tree.printTree();

        System.out.println("是否為合法AVL樹：" + tree.isValidAVL());
    }
